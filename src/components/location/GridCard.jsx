...
export default function GridCard({ shop }) {
  ...
  return (
    <div style={{
      ...
      onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 8px 28px rgba(10,35,66,0.11)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
      ...
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 7, flex: 1 }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            <ServiceIcon name={deliveryIcon} style={{ fontSize: 11, color: '#00897b', fontVariationSettings: "'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24" }} />
            {shop.delivery}
          </span>
          <button style={{
