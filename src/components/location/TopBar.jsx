import { GridIcon, MapViewIcon, ChevronDownIcon } from './Icons';
...
export default function TopBar({ view, setView, total, sort, setSort }) {
  const btnBase = {
  ...
  const activeStyle = { background: '#0a2342', color: '#fff', borderColor: '#0a2342' };
  const inactiveStyle = { background: '#fff', color: '#6b7a8d' };
