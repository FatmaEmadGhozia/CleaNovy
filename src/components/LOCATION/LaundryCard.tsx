...
export default function LaundryCard({ shop }: LaundryCardProps) {
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = '0 6px 24px rgba(10,35,66,0.09)';
      ...
      <div style={{ flex: 1, padding: '10px 12px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 7 }}>
          <span style={{
            ...
            <ServiceIcon
              name={deliveryIcon}
              style={{ fontSize: 12, color: '#00897b', fontVariationSettings: "'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24" }}
            />
            {shop.delivery}
          </span>
          <button style={{
