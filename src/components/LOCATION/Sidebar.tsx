...
/* ── shared token values (mirror admin palette) ── */
const NAVY   = '#0D1F3C';
const TEAL   = '#00C9B1';
const BG     = '#F4F6F9';
const BORDER = '#e8eaed';
      ...
      <div style={{ ...sectionStyle, position: 'relative' }}>
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              fontSize: 12, color: NAVY, width: '100%',
        ...
        {showSuggestions && search && filtered.length > 0 && (
          <div style={{
            ...
            boxShadow: '0 4px 12px rgba(0,0,0,0.07)', overflow: 'hidden', marginTop: 2,
          }}>
            {filtered.map((area) => (
              <div
                key={area.name}
                ...
                style={{
                  padding: '8px 12px', fontSize: 12, color: NAVY,
      ...
      <div style={sectionStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <span style={{
            ...
            border: `1px solid ${TEAL}40`, borderRadius: 20,
            ...
            return (
              <label key={key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div onClick={() => toggleService(key)} style={{
                  ...
                  border: `2px solid ${checked ? TEAL : BORDER}`,
                ...
                <span style={{ fontSize: 12.5, color: NAVY, fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div style={sectionStyle}>
        ...
        <div style={{ display: 'flex', gap: 5 }}>
          {PRICE_OPTIONS.map((opt: string) => {
            const active = filters.price === opt;
            return (
              <button
                key={opt}
                type="button"
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <button
            ...
            style={{
              ...
              background: filters.fastDelivery ? TEAL : BORDER,
          ...
          <span style={{ fontSize: 12, color: NAVY, fontFamily: "'Tajawal', sans-serif" }}>
            خدمة التوصيل السريع
          </span>
        </div>
      </div>
