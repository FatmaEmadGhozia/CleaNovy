...
export default function SuccessScreen({ name, onReset }: SuccessScreenProps): React.ReactElement {
  return (
    <div style={{
      display: "flex", flexDirection: "column", alignItems: "center",
      justifyContent: "center", padding: "48px 0", gap: 20, textAlign: "center",
    }}>
      {/* Check circle */}
      <div style={{
        ...
        <div style={{
          ...
          border: "2px solid #14b8a6", animation: "pulse-ring 1.5s ease-out infinite",
        }} />
