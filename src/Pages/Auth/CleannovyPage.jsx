...
export default function CleannovyPage() {
  ...
  const { shops, loading, error, usingMock } = useShops(filters, sort); 
    ...
    <div style={{
      ...
      {usingMock && (
        <div style={{
          ...
          <span>⚠️</span>
          <span>
            الـ API مش متاح حالياً — تأكدي إن الـ backend شغال على port 5000
          </span>
