      ...
      <section className="flex w-full items-center justify-center bg-white px-6 py-10 lg:w-1/2">
        ...
        >
          ...
          <div className="anim-fsu d2 mb-7" style={{ textAlign: "right" }}>
            <h1 className="mb-2" style={{ fontFamily: "Cairo", fontSize: 32, fontWeight: 700, color: "#000719", lineHeight: 1.3 }}>
            ...
            <div className="anim-sp flex flex-col items-center gap-5 py-10">
              ...
              >
                <span
                  ...
                  style={{ fontSize: 48, color: "#006b5d", fontVariationSettings: "'FILL' 1,'wght' 400,'GRAD' 0,'opsz' 48" }}
                >
                  check_circle
                </span>
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 9999, padding: "12px 40px",
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
              ...
              <div className="anim-fsu d6">
                <button
                  type="submit"
                  style={{
                    width: "100%", backgroundColor: "#006b5d", color: "#fff",
                    fontFamily: "Cairo", fontSize: 20, fontWeight: 700,
                    padding: "16px 0", borderRadius: 9999, border: "none",
                    cursor: "pointer", boxShadow: "0 8px 24px rgba(0,107,93,0.2)",
                    transition: "background 0.2s, transform 0.1s",
                  }}
                  onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#005046")}
                  onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#006b5d")}
