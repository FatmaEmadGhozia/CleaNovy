...
//         const catRes = await fetch(`${BASE_URL}/provider/services/categories`);
//         const catJson = await catRes.json();
//         if (catJson.success) {
//           setCategories(catJson.data.map((c: any) => ({
//             id: c._id, label: c.name, icon: c.icon || "category", count: c.count, isBasic: c.isBasic,
//           })));
//         }
//         pushNotification("تمت إضافة خدمة جديدة", `تم إضافة "${form.name}" إلى قائمة الخدمات`);
//         showToast("تمت إضافة الخدمة بنجاح");
...
//       showToast("تعذر الاتصال بالسيرفر", "error");
//     }
//   }, [fetchServices, pushNotification, showToast]);
