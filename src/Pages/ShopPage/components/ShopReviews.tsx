...
import { ShopReview } from "../shopApi";
    ...
    <div className="nv-review-rating-input">
      {[1, 2, 3, 4, 5].map((i) => (
        <span
          ...
          style={{ color: i <= (hover || value) ? "var(--nv-gold)" : "var(--nv-border)" }}
  ...
  return (
    <div>
      <div className="nv-add-review-box">
        <div className="nv-side-title" style={{ marginBottom: 12 }}>أضف تقييمك</div>
      ...
      {reviews.length === 0 ? (
        <p style={{ textAlign: "center", color: "var(--nv-muted)", padding: "24px 0" }}>
          ...
          <div key={r._id} className="nv-review-card">
            <div className="nv-review-head">
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: "var(--nv-navy)" }}>
                  {r.client}
                </span>
              </div>
