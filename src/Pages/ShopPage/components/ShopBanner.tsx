      ...
      <div className="nv-banner-content">
        <div className="nv-banner-text">
          ...
          <div className="nv-badges">
            ...
            {shop.is_verified && <span className="nv-badge nv-badge-gold">موثّقة</span>}
            {shop.avg_rating && (
              <span className="nv-badge nv-badge-rating">⭐ {shop.avg_rating.toFixed(1)}</span>
            )}
          </div>
        </div>
        <div className="nv-shop-logo">
          ...
          {shop.avg_rating && (
            <div className="nv-shop-rating">⭐ {shop.avg_rating.toFixed(1)}</div>
          )}
        </div>
      </div>
    </section>
